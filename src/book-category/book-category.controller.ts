...
export class BookCategoryController {
  ...
  findOne(@Param('id') id: string) {
    // ❌ ของเดิม: return this.bookCategoryService.findOne(+id);
    // ✅ แก้เป็น (ลบ + ออก):
  ...
  update(@Param('id') id: string, @Body() updateBookCategoryDto: UpdateBookCategoryDto) {
    // ❌ ของเดิม: return this.bookCategoryService.update(+id, updateBookCategoryDto);
    // ✅ แก้เป็น (ลบ + ออก):
  ...
  remove(@Param('id') id: string) {
    // ❌ ของเดิม: return this.bookCategoryService.remove(+id);
    // ✅ แก้เป็น (ลบ + ออก):
